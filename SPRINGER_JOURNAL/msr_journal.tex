...
Exception message improves error diagnosis &	10	& 15\% \\
Anticipated erroneous situation help writing more robust code & 9	 & 13\% \\
Exceptions for unrecoverable behavior	& 7 &	10\% \\
Checked exceptions force handling  &	6	& 9\% \\
Useful to gracefully crash 	& 4 &	6\% \\
		
\bfseries{For Negatively Affecting Robustness} &   &   \\
Exceptions should be caught to improve robustness	& 7	& 10\% \\
Creates a different control flow makes debugging harder &	2 &	3\% \\
unchecked/runtime exceptions favor crashes	& 2	& 3\% \\
NullPointerExceptoins are tricky to avoid	 & 2	& 3\% \\
Many device specific exceptions prevent proper handling	& 1 & 1\% \\
...
\hline
Handling exceptions & 18 & 25\% \\
       - handling exceptions in all entry points/all over	  &   &   \\	
       - using catch-all clauses 		  &   &   \\	
       - addinf try catch bocks around risky methods		  &   &   \\	
Crash report tools	& 6 &	8\% \\
Null checks &	11	& 15\% \\
 - null check annotations (@Null and @NonNull)	& 3 & 	4\% \\
Edge cases/boundaries checks  &	4 &	6\% \\
Testing &	15 &	21\% \\

Let it crash and fix afterward	& 4 & 6\% \\

Many device specific exceptions prevent proper handling	& 1 & 1\% \\

\hline
\end{tabular}
\caption{Top ways of preventing crashes }
\label{tab:topreasons}
\end{table}
