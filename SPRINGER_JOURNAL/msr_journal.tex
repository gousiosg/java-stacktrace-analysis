...
\textcolor{red}{The survey mixed Liket-scale with open-ended questions, and the motivations behind the survey questions are twofold: (i) to learn from developers about the usage of the exception handling code in app development;  and (ii) to get developers percerptions about the bug hazards detected in the first phase of this study.}
...
The survey consists of multiple choice or Likert-scale questions (to force participants to make a choice) intermixed with open-ended questions to further elicit the developer's opinions.
...
Overall, the survey includes 13 open-ended questions, 5 Likert-scale questions and 10 multiple choice questions. The respondents could complete the survey in about 15 minutes.
...
%We used grounded theory coding~\cite{charmaz2006}, iterating through our open-ended survey re% sponses, to answer some of the research questions. The 
%grounded theory coding used in this study consists of two phases: (1) initial coding entailing a close reading of the data and (2) focused 
%coding~\cite{charmaz2006} to pinpoint and develop the most salient themes~\cite{charmaz2006} in the analyzed data. The coding process was performed 
%by two coders who agreed upon the list of themes that emerged from the answer set of each question.
