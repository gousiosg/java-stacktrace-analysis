...
\noindent\emph{\textbf{Q2: How the exception handling code affect the development of robust apps and how developers prevent apps from crashing?}}
...
\noindent\emph{\textbf{Q3.1: How NullPointerException impact the development of robust Android apps?}}
...
\noindent\emph{\textbf{Q3.2: How Cross-Type Wrappings impact the development of robust Android apps?}}

\bigskip

Some of the best practices are related to the different ways of handling checked and unchecked exceptions. When the designer of an API specifies that a method throws a checked exception, it is telling
the caller of the API that such exception should be handled.
...
\bigskip
\noindent\emph{\textbf{RQ 3.3 Are developers aware the hidden dangers of non-declared checked exceptions?}}
\bigskip
