...
although the response rate achieved in our study is low, it is inlined to similar surveys reported in the literature (e.g., ~\cite{kochhar2015understanding,joorabchi2013real,bavota2015impact,ko2007information,hindle2015topics}) whose response rates mostly varies between 2\% and 4\%.}
...
tools to help with specific development tasks.
 \textcolor{red}{Some of such exploratory surveys were applied to Android developers~\cite{kochhar2015understanding,joorabchi2013real,bavota2015impact,linares2015developers}.
...
Joorabchi et al. ~\cite{joorabchi2013real} performed a survey-based study whose goal was to better understand the the main challenges
...
the developers' perspective regarding a set of exception handling bug hazards. In our study
