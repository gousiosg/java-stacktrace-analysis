...
\begin{tabular}{lrr}
\hline
\bfseries{Top 5 Resons} & \bfseries{\#} & \bfseries{\%} \\
\hline
\bfseries{For Positively Affecting Robustness} &   &   \\
Programming logic (java.lang and util)  & 52,0\% & 52,0\%\\
Resources (IO, Memory, Batery)  & 52,0\% & 23,9\% \\
Security  & 52,0\% & 4,1\%\\
Concurrency  & 52,0\% & 2,9\% \\
Backward compatibility  & 52,0\% & 5,5\% \\
\bfseries{For Negatively Affecting Robustness} &   &   \\
Specific Exceptions  & 52,0\% & 4,9\%\\
General (Error, Exception, Runtime)  & 52,0\% & 6,7\%\\
Specific Exceptions  & 52,0\% & 4,9\%\\
General (Error, Exception, Runtime)  & 52,0\% & 6,7\%\\
\hline
\end{tabular}
