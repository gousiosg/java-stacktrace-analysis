...
Moreover, few respondents also answered that such NullPointerException crashes can be caused by backward compatibility as well as memory issues as illustrated in Table X. The other half mentoned that NullPointerExceptions are  common in Android development as it is common in Java standard development.		
...
\bigskip
\noindent\emph{\textbf{RQ 4 Are developers aware of the non-declared checked exceptions?}}
\bigskip
