...
(e.g., faults in underlying middleware or hardware; compatibility issues~\cite{McDon13}; memory and batery restrictions; noisy external resources~\cite{Zhang12}). 
