...
\emph{\textbf{RQ 1:}How often developers deal with the exception handling code in Android development?} To make the analysis easier, we further refine RQ1 in the following subquestions:
\begin{itemize}
\item RQ1.1:\emph{How often developers handle exceptions?}
\item RQ1.2:\emph{How often developers throw exceptions?}
\end{itemize}

Another theme that show us how developers may deal with such bug hazards is
...
\emph{\textbf{RQ 2:}Do developers know about exception handling best practices?}
...
\begin{figure} \centering \includegraphics[scale=0.35]{charts/Q1Q2.png}
...
We also include direct quotes from developers along the text with the answer identification - which can be traced in our dtabase. 

\bigskip

\noindent\emph{\textbf{Q1:How often developers deal with the exception handling code in Android development?}}
...
\begin{figure} \centering \includegraphics[scale=0.35]{charts/Q3Q4.png}
\caption{How often.}
...
\begin{figure} \centering \includegraphics[scale=0.35]{charts/Q7Q8.png}
\caption{How often.}
\label{fig:oftenhandle}
\end{figure}
