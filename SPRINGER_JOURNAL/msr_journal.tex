...
\subtitle{Results from a Mining and Exploratory Survey Study}
...
\begin{figure} \centering \includegraphics[scale=0.63]{charts/agree_new2.png}
\caption{How often developers throw and handle exceptions during app development.}
\label{fig:oftenhandle}
\end{figure}


\begin{figure} \centering \includegraphics[scale=0.57]{charts/yes_no_new2.png}
...
%[width=.9\hsize]
\begin{figure*} 
\centering \includegraphics[scale=0.42]{charts/maincauses.png}
