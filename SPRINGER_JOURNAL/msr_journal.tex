...
In this section each piece information is then analyzed in detail to 
...
\noindent\emph{\textbf{RQ 2.2: How do the NullPointerExceptions impact the development of robust Android apps?}}
...
\noindent\emph{\textbf{RQ 2.3: How do Cross-Type Wrappings impact the development of robust Android apps?}}
...
\bigskip
\noindent\emph{\textbf{RQ 2.4: Are developers aware of the robustness threats caused by JNI undocumented checked exceptions?}}
\bigskip
...
\noindent\emph{\textbf{RQ 2.5: How does the exception handling code affect the development of robust apps and how do developers prevent apps from crashing?}}
