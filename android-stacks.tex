...
Figure~\ref{fig:wrapping} presents an example of a stack trace, on which multiple 
...
If we filter the exceptions implicitly signaled by JVM (due to coding erros) the number of runtime
exceptions thrown by third party code is XXX signaled by Android and YYY signaled by library code.
