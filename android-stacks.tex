...
available on exception stack traces. The exceptions available on exception stack trace
are not limited to the exceptions expliciltly thrown by the Java developer but also include
...
with manual inspection to to everage the  understanding of stack traces. 
...
\subsection{Study Context and Github Data}
\label{sec:git}


 What is the prevalence of stack traces on reported issues?
