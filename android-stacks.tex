...
and Google Code (157 projsects). The goal of this study is to investigate whether the analysis of stack traces information 
could reveal bug hazards related to the exception handling code that may lead to a 
decrease in application robustness. A bug hazard is a circumstance that increases the 
chance of a bug to be present in the software. Overall 6,005 exception stack traces were extracted, and analyzed in 
combination with source code and bytecode analysis. 
Some of the outcomes of this study includes the identification of the following 
