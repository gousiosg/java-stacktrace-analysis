...
characteristics distilled from stack traces: (i) the root exceptions, (ii) the exception types, 
and (iii) the exception wrappings.  Each part is then analyzed in detail to 
