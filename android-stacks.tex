...
Overall, our research set includes 32,582 issues in GitHub and 41,674 issues in Googlecode 
from which 6,005 exception stack traces were extracted. Such stack traces were distilled and analyzed in 
...
A multitude of programming mistakes were reported as the main causes of stack traces.
51,96\% of all projects reported at least one exception stack trace on which the NullPoiterException
was the root cause.
}
\end{minipage}}
