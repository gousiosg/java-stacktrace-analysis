...
Modern applications have to cope with similar and increasing number of sources of failures
 that arise as a consequence of faults in the application
...
mechanism~\cite{goodenough1975exception}, been embedded in several 
programming languages (e.g. Java, C++, C\#), is one of the most used
 schemes for detecting and recovering from such failures. 

Such exception stack traces are a useful source of 
...
However existing research has focused on the analysis of a 
