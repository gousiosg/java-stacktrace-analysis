...
unresponsivedue due to resurce limitation and excessive network access) the
Android Application Framework also provides APIs to support concurrent 
developement (e.g. AsyncTask).
