...
thrown by both the Android platform and third party libraries; and (iii) undocumented checked exceptions
 thrown by the Android Platform. Such undocumented exceptions make it difficult, and most of the times infeasible
...
%A bug hazard is a circumstance that increases the chance of a bug being present in the software.
\end{abstract}
