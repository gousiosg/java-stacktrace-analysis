...
instances of java.lang.RuntimeException). We could observe observe that only 1 method out of 118 inspected signalers
 (i.e., 0,8%) documented the explicitly thrown runtime exceptions in a Javadoc comment, and none of the analized 
included the exception  as part of the exception interface of the method (i.e., using throws clause on method signature). 
