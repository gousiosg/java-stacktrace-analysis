...
extracted from the JDK, Android Platform and the application layer.
...
Methods defined on 11 android packages signaling direct instances of RuntimeException.
}
\end{minipage}}
