...
such a wrapping a ``cross-type wrapping".  Such wrappings reveals 
violations to best practices I and II (e.g. Error wrapping a Checked exception),
To illustrate the problem behind such wrappings, we can use one of the wrappings found in this study. 
...
Next we discuss and exemplify the cross-type wrappings
 found in this study.
...
\noindent \fbox{ \begin{minipage}{0.96\columnwidth} \emph{
MUDARRRR Odd wrappings were detected (e.g., a checked exception wrapping an OutOfMemoryError).
The study also detected an undocumented checked exception signaled by a native method defined in Android.
}
\end{minipage}}
...
To illustrate this problem, we can use one of the examples found in this study: when the developer is 
