...
Often some exception handling constructions may lead the developers into believing that
...
the developer to better dealing with them. Last but not least, the high amout of null pointer exceptions 
points to the usefullness of language designs which avoid such problems such as Monads ~cite{Walde95}, 
used in functional languages  for values that may not be available or computations that may fail.
