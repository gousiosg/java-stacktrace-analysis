...
%\title{A first Glance of what is causing Mobile Crashes: A GitHub and Googlecode Repository Mining Study }
...
Such wrapping was detected on distinct 70 projects. Inspecting the elements responsible for performing such wrapping we could observe that,
...
(com.github.andlyticsproject.console.NetworkException,org.apache.http.client.HttpResponseException)	5
...
org.springframework.web.client.ResourceAccessException	6
com.github.andlyticsproject.console.DevConsoleProtocolException	3
...
(com.octo.android.robospice.persistence.exception.CacheSavingException,java.lang.ClassCastException)	6
(java.lang.reflect.InvocationTargetException,java.lang.NullPointerException)	3
(java.lang.reflect.InvocationTargetException,android.content.res.ResourcesdNotFoundException)	2
...
NATIVE IMPLEMENTATION, WE DO NOT HAVE ACCESS TO THE SOURCE CODE… IT IS IN C…
CHECKED EXCEPTIONS CAN BE THROWN BY NATIVE METHODS…. ANY CHANING IS PERFORMED?
...
but wrapphing any exception on a general Exception make the matters worse.
...
All ClassDefFound wrappings were caused by java.lang.Class methods such as 
at java.lang.Class.getDeclaredFields(Native Method)
at java.lang.Class.getDeclaredConstructors(Native Method). They are all NATIVE METHODS.
