...
\emph{\textbf{Error wrapping Runtime.}} After manually inspecting the source code associated to such wrappings 
...
incurring into a situation as the one described above. 
...
pin-point fragilities on the exception-related code based on 
