...
Throwing general exceptions is  considered a
...
"call backs", when a application throws a runtime exception (i.e., one of the life cicle methods of an Activity) and does it, the exception scapes to compotenst of the Android platform 
which do not have contextual information to adequately handle
the exception and simply terminates the application. 

We could observe that although been known as a bad practice, the signaling general exceptions in this context it was an intended design decision when no specific recovery action can be defined for the exception.
