...
This classification also enable us to find stack traces reporting exceptions 
directly related to concerns often mentioned on research
works on Android Plaftorm, such as: Concurrency, Backward compatibility, Security, etc.
Considering this broader set the programming mistakesstill represent most of the causes (55,64\%)
of the analyzed exception stack traces.
...
\centering
\begin{tabular}{lll}
 \bfseries{Method} & \bfseries{Project} & \bfseries{Ocurrences}\\
    \hline
android.os.AsyncTask &	122 & 549  \\
android.view.LayoutInflater & 63 & 163 \\
android.support.v4.* & 100 & 512\\
\hline
  \end{tabular}
\caption{Elements tresponsible for the wrapping.}
\label{tab:wrapping01}
