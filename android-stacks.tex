...
to its origin (i.e. Android Plaform, Aplication, Library, Libcore, or Java) 
based on pattern matching between the signaler name and the packages associated to each category.
TELL THAT ALL PACKAGES COMPOSISNG APPS .... WERE RECOVED....
...
\subsubsection{The Minig Process}
...
\subsection{The Most Common Root Exceptions }
...
\subsubsection{What They can Tell us?}
