...
the Dalvik runtime environment, and the framework which provides higher-level services to the applications
...
receiving the GUI events is the Activity, it is the unity of user interaction and execution in
Android. Android also provides APIs for data storage, communication between Activities, 
and other services. Moreover, it also provide frameworks for concurrent developement (e.g. AsyncTask) 
which is higly encouraged in Android development due to plaftorm restrictions [shimidit and arie].
\footnote{Other elements compose an application such as the Intents, resources
but are out of the scope for this paper.}.
