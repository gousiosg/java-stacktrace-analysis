...
retrieve our sample, it included  16.836 Java projects (step 1) which overall contained
356.057 issues.\footnote{A Java project is specified in GitHub with a
specific label.}

After obtaining this sample of projects and associated issues, 
the ExceptionMiner tool, developed in this work, performed a per-project 
mining task as follows: for each project, the content of each issue and issue comments 
were analized and all exceptions and exception stack traces were extracted (step 2). 
Since this initial set of Java project is too diverse (it includes libraries, web-based or
