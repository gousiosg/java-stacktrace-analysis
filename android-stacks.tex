...
uses the Design Wizard framework \cite{Brunet09} to inspect the bytecode of all exceptions reported on issues,
...
root exception, consisting of 100 exceptions
reported on 95\% of all stack traces analyzed in this study. Hence, based on the inspection of the 
