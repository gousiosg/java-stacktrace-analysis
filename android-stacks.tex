...
quantitative and qualitative analysis of the outcomes. The structure of this section
 is centered on questions that guied the search for 
source-code fragilities based on exception stack trace information.
...
programming mistakes of reported exception stack traces we performed the following analysis....
