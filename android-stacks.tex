...
\noindent\emph{External Validity.} We limited out analysis to a subset of
existing open-source Android apps. We are aware that the reported exceptions 
...
\textit{Detecting Faults on Java Exception-Related Code.}  Some tools have been 
proposed to detect faults  
...
Robillard and Murphy~\cite{Robil00} employed dataflow analysis to find the propagation paths of checked and
