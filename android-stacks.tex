...
the number of open source software (oss) available on the Web.
Since such projects make their control version system, mailing lists and 
bug tracking systems (bts) publicly available, they represent a valuable 
source of information for the "state of practice" on software development
which has already started to be investigated [][][][][].
...
Github is also known as a social coding platfotm [ref] as it ....
...
The bug issues have been the focus of some research... In [ref] defined a 
set of characteristics a good bug issue should have. The 2 most important information 
are the: (1) steps to reproduce the bug; (2) and the failure stack trace.
...
on open-source repositories like GitHub additional questions arise: What are the common
characteristics of such stack traces? Can developers benefit from other systems faults?
